...
\begin{cventries}
    ...
    { % Description(s) of tasks/responsibilities
        \begin{cvitems}
            \item {Created the proof of concept hardware and software required to port our vision system and proprietary AI control to a 3rd party robotic
                        welding apparatus.}
            \begin{itemize}
    ...
    { % Description(s) of tasks/responsibilities
        \begin{cvitems}
            ...
            \item {Responsible for EU Machinery and EMC Directive compliance. Oversaw testing according to IEC/EN 60204-1 and IEC/EN 61000-6-4.}
