...
\begin{cventries}
    ...
    { % Description(s) of tasks/responsibilities
        ...
        \end{cvitems}
        \vspace{3mm}
        \entrypositionstyle {Environment: }\entrylocationstyle {C, C++, Python, Atmega16L Controller, STM32F4 Controller, ProconOS, J1939 CANBus, Opus Make }
        \vspace{1mm}
    }
    ...
    { % Description(s) of tasks/responsibilities
        ...
        \end{cvitems}
        \vspace{3mm}
        \entrypositionstyle {Environment: }\entrylocationstyle {C, C++, Atmega32U4 Controller, J1939 CANBus }
        \vspace{1mm}
    }
    ...
    { % Description(s) of tasks/responsibilities
        ...
        \end{cvitems}
        \vspace{3mm}
        \entrypositionstyle {Environment: }\entrylocationstyle { C, IEC 61161-3, STW ESX Controller, dsPIC33 Controller, CANBus }
        \vspace{1mm}
    }
