...
\begin{cventries}
    ...
    {
        \begin{cvitems}
            \item {Developed embedded diagnostic communication stacks including DoIP and ZEVonUDS for STM32F7-based systems.}
            \item {Implemented network services using lwIP and integrated FreeRTOS for real-time scheduling, synchronization, and multi-threaded communication tasks.}
            \item {Designed and maintained internal development and testing tools in Python and Go to support automation, validation, and workflow efficiency.}
            \item {Administered and maintained the company's AWS-hosted web API infrastructure, including deployments, monitoring, and access control.}
            \item {Led testing and release processes, ensuring reliable firmware builds, regression validation, and controlled production rollouts.}
        \end{cvitems}
        \vspace{3mm}
        \entrypositionstyle{Environment: }\entrylocationstyle{C, C++, Python, Go, STM32F4/F7 MCU, FreeRTOS, lwIP, DoIP, ZEVonUDS, SAE J1979-2/3, J1939 CANBus, AWS, CMake}
        \vspace{1mm}
    }
